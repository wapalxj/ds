package byd.algorithms.liuyubobobo.datastructure_algorithm.src.chapter3_sort_advance.more;
...
public class InversionCount{
    ...
    public static void main(String[] args) {
        ...
        System.out.println("TestPrintStars Inversion Count for Random Array, n = " + N + " :" + solve(arr) );

        // 测试2: 测试完全有序的数组
        // 结果应该为0
        arr = SortTestHelper.generateOrderedArray(N);
        System.out.println("TestPrintStars Inversion Count for Ordered Array, n = " + N + " :" + solve(arr) );

        // 测试3: 测试完全逆序的数组
        // 结果应改为 N*(N-1)/2
        arr = SortTestHelper.generateInversedArray(N);
        System.out.println("TestPrintStars Inversion Count for Inversed Array, n = " + N + " :" + solve(arr) );
    }
}